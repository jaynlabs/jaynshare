// Reflect the active account in the terminal title (e.g. "◆ jaynshare 2/4 work"),
// so a backgrounded or tabbed `jaynshare server` is glanceable without
...
// Short, glanceable title: "jaynshare <pos>/<total> <name>". `index` is 0-based.
