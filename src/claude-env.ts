...
export function encodePinComponent(s: string): string {
...
export function buildClaudeEnvLines({ port, useMitm = true, caPath = null, holdSeconds = 0, account = null, proxyApiKey = '' }: ClaudeEnvOptions): string[] {
  const lines: string[] = [];
