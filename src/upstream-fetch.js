...
// a dead socket. Override with JAYNSHARE_UPSTREAM_HEADERS_TIMEOUT_MS (or
// per-call opts).
...
function headersTimeoutError(ms) {
  ...
  err.code = 'JAYNSHARE_HEADERS_TIMEOUT';
  return err;
}
...
/**
 * `fetch` for jaynshare's own control-plane calls — OAuth token exchange and
